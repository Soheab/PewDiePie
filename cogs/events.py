...
class Events:
    ...
    async def on_guild_join(self, guild):
        ...
        em.add_field(name = "Bot Count", value = format(len([b for b in guild.members if b.bot]), ",d"))
        em.add_field(name = "Human Count", value = format(guild.member_count - len([b for b in guild.members if b.bot]), ",d"))
